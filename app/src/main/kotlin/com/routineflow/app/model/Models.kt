...
data class Action(val id: Long, val title: String, val recurrence: String, val durationSeconds: Int = 60, val doneOn: String? = null, val executionStatus: String? = null)
