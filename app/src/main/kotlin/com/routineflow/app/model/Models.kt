...
data class Action(val id: Long, val title: String, val recurrence: RecurrenceRule, val durationSeconds: Int = 60, val doneOn: String? = null, val executionStatus: String? = null, val actualDurationSeconds: Long? = null, val speechKey: String? = null)
