...
1. Перед началом изменения посмотреть последнюю версию в `CHANGELOG.md` и определить следующую.
...
2. Предложить возможные вариант решения, дождаться подтверждения
3. Найти существующий переиспользуемый код.
4. Реализовать изменение в правильном каталоге.
5. Добавить тесты.
6. Обновить CHANGELOG.
7. Обновить README/CHANGELOG при необходимости.
